    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Gap(ScreenSize.h30),
          Text(" Email",style: AppTheme.data.textTheme.bodyMedium!.copyWith(fontSize: ScreenSize.sp12,fontWeight: FontWeight.w700)),
          Gap(ScreenSize.h5),
          Row(
            children: [
              Expanded(
         ...
         Gap(ScreenSize.h25),
          ...
          Row(
            children: [
              ...
              IconButton(onPressed: (){}, icon: Icon(Icons.visibility,color: AppTheme.colors.grey1,size: ScreenSize.h20)),
            ],
          ),
          Container(height: 1,width: double.infinity,color: AppTheme.colors.primary),
          ...
          Row(
            children: [
              IconButton(onPressed: (){}, icon: SvgPicture.asset(AppIcons.checkOff)),
              Gap(ScreenSize.h7),
              Expanded(
                child: RichText(
                    text: TextSpan(
